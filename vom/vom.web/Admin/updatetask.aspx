<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="updatetask.aspx.cs" Inherits="vom.web.Admin.updatetask" %>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="well">
                   ...
                   <div class="form-group">
                    ...
                    <a href="task.aspx?user_uuid=<%=user["uuid"]%>" class="btn btn-lg btn-default"><i class="fa vom-green fa-backward"></i> Back to task</a>
                </form>
                </div>
