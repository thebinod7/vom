<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/employee.Master" AutoEventWireup="true" CodeBehind="emp_changepassword.aspx.cs" Inherits="vom.web.Employee.emp_changepassword" %>
                ...
                <form role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-offset-3 col-md-9">
                            <button id="btn-changepassword" type="button" onclick="UpdateEmpPassword()" class="btn btn-lg btn-primary">&nbsp Change Password</button>
                        </div>
                    </div>
                </form>
            </div>
